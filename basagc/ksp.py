...
def get_telemetry(telemetry_type, telemetry, stream=False, refssmat=None, **kwargs):
    return connection.get_telemetry(telemetry_type, telemetry, stream, refssmat, **kwargs)
